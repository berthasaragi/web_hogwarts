...
<head>
    ...
    <title> Visi Misi Hogwarts University</title>
    <!-- icon -->
...
<body>
    ...
    <!-- akhir navbar -->
    <!-- content -->
    <h1 class="text-light text-center p-4 mt-5 mb-5 bg-dark shadow-sm">Visi dan Misi</h1>
    <div class="container mt-3 mb-3">
        <h2>A. Visi</h2>
        <p>Menjadi pusat keunggulan dalam pendidikan sihir dan ilmu pengetahuan di dunia wizarding.
        </p>
        <h2>B. Misi</h2>

        <p>Memberikan pendidikan berkualitas tinggi yang menggabungkan tradisi dan inovasi dalam ilmu sihir.
        <li>Mendorong pertumbuhan karakter yang kuat, kreativitas, dan kepemimpinan pada setiap siswa.</li>
        <li>Menyediakan lingkungan belajar yang inklusif dan mendukung bagi semua anggota komunitas.</li>
        <li>Menginspirasi siswa untuk menjelajahi dan mengembangkan potensi mereka dalam berbagai bidang sihir</li>
        </p>
    </div>
    <!-- akhir content -->
     <!-- Footer -->
